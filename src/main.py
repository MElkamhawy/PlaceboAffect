...
def main(
    ...
    # Extract features
    data_train_vector = extract_features.FeatureVector(data_train.texts, name="train")
    data_dev_vector = extract_features.FeatureVector(data_dev.texts, name="dev")
    data_train_vector.process_features(empath=empath)
    data_dev_vector.process_features(
        vectorizer=data_train_vector.vectorizer, empath=empath
    )
    ...
    # Predict on Dev Set
    pred_labels = clf.predict(data_dev_vector)
